...
To visit locally, go to 'http://localhost:3000/'
'http://localhost:3000/spotify-modern.html' — modern Spotify only UI (what this originated from)
'http://localhost:3000/classic.html' — legacy Spotify only UI for ancient WebKit
iOS 6's WebKit displays this perfectly.
iOS 3 has a view visual changes from the simpler rendering
  - Spotify element doesn't work on Smart home, making it literally useless
  - Spofity volume control doesn't seem to work on the Legacy Spotify only UI
